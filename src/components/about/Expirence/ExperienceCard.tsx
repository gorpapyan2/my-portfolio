      ...
      <Card className="group hover:bg-[var(--surface-strong)] transition-all duration-500">
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <p className="text-accent font-medium">{tv('company', company)}</p>
          </div>
        ...
        <p className="text-[var(--text-muted)] mb-6 leading-relaxed">{tv('description', description)}</p>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-3">
            {achievementsToRender.map((achievement, index) => (
              ...
              >
                <div className="flex-shrink-0 w-2 h-2 bg-accent rounded-full mt-2 group-hover:scale-125 transition-transform duration-300" />
