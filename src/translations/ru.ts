export const ru = {
  ...
  'aria.previousTechnology': 'Предыдущая технология',
  'aria.nextTechnology': 'Следующая технология',
  ...
  'about.fallback.journey': 'Профессиональный путь скоро появится.',
  'about.fallback.philosophy': 'Детали философии скоро появятся.',
  'about.fallback.toolbox': 'Инструментарий скоро появится.',
  'about.fallback.error': 'Не удалось загрузить контент. Пожалуйста, попробуйте снова.',
  'about.portraitAlt': 'Портрет Гор Папян',
  'about.headline': 'Специалист по автоматизации QA, специализирующийся на детерминированном тестировании и надежной поставке.',
  'about.keyResults.title': 'Ключевые результаты',
  'about.keyResults.4': 'Ноль производственных дефектов в критических потоках благодаря надежной предварительной проверке.',
  'about.keyResults.5': 'Автоматизировано более 80% основных пользовательских сценариев с помощью Playwright/TypeScript.',
  'about.keyResults.6': 'Внедрено контрактное тестирование для микросервисов, что сократило проблемы интеграции.',
  'about.keyResults.7': 'Оптимизированы тестовые среды на базе Docker для согласованности между локальной средой и CI.',
  'about.keyResults.8': 'Установлены качественные пороги в Jenkins/GitHub Actions для каждого PR.',
  'about.keyResults.9': 'Время настройки среды сокращено на 50% с использованием инфраструктуры как кода.',
  'about.keyResults.10': 'Улучшена отчетность о тестировании с визуальными артефактами и показателями производительности.',
  'about.keyResults.11': 'Наставничество младших инженеров по контролю качества по современным методам автоматизации.',
  'about.keyResults.12': 'Покрытие тестами API улучшено на 60% благодаря автоматическим проверкам документации.',
  'about.keyResults.empty': 'Ключевые результаты скоро появятся.',
  'about.quickFacts.title': 'Краткая информация',
  'about.quickFacts.location': 'Местоположение',
  'about.quickFacts.experience': 'Опыт',
  ...
  'technologies.detailsTitle': 'Подробный обзор',
  'technologies.impactTitle': 'Реальное влияние',

  // Loading
  'loading.welcome': 'Добро пожаловать! Подготавливаем все для вас...',
  'loading.settingUp': 'Один момент, настраиваем все...',
  'loading.almostReady': 'Почти готово! Подготавливаем ваш опыт...',
  'loading.patience': 'Спасибо за ваше терпение...',
  'loading.hint': 'Пожалуйста, подождите, пока мы загрузим ваш предпочтительный язык...',
};
