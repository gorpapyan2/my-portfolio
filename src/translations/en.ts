export const en = {
  ...
  'skills.manualTesting': 'Manual & Exploratory Testing',
  'skills.apiTesting': 'API Testing',
  'skills.cicdDevops': 'CI/CD & DevOps',
  'skills.versionControl': 'Version Control',
  'skills.crossBrowser': 'Cross-browser & Web',
  ...
  'settings.deleteTranslation': 'Delete Translation',
  ...
  'settings.exportTranslations': 'Export Translations',
  'settings.importTranslations': 'Import Translations',
  ...
  'technologies.subtitle': 'Leveraging modern tools and technologies to ensure software quality',
  'technologies.testing': 'Testing Frameworks',
