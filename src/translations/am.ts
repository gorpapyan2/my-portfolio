export const am = {
  ...
  'skills.manualTesting': 'Ձեռքով և հետազոտական թեստավորում',
  'skills.apiTesting': 'API թեստավորում',
  'skills.cicdDevops': 'CI/CD և DevOps',
  'skills.versionControl': 'Տարբերակների վերահսկում',
  'skills.crossBrowser': 'Խաչաձև հարթակ և վեբ',
  ...
  'settings.addTranslation': 'Ավելացնել թարգմանություն',
  'settings.editTranslation': 'Խմբագրել թարգմանությունը',
  'settings.deleteTranslation': 'Ջնջել թարգմանությունը',
  'settings.searchPlaceholder': 'Փնտրել թարգմանություններ...',
  'settings.filterByCategory': 'Զտել ըստ կատեգորիայի',
  'settings.allCategories': 'Բոլոր կատեգորիաները',
  'settings.importExport': 'Ներմուծում / Արտահանում',
  'settings.exportTranslations': 'Արտահանել թարգմանությունները',
  'settings.importTranslations': 'Ներմուծել թարգմանությունները',
  'settings.downloadTemplate': 'Ներբեռնել կաղապար',
  'settings.validation': 'Ստուգում',
  'settings.missingTranslations': 'Բացակայող թարգմանություններ',
  ...
  'technologies.subtitle': 'Ժամանակակից գործիքների օգտագործում՝ ծրագրային ապահովման որակն ապահովելու համար',
  'technologies.testing': 'Թեստավորման Շրջանակներ',
