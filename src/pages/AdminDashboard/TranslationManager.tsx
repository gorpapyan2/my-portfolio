        ...
        <div className="flex gap-2">
          <div className="relative">
            ...
            <select
              ...
              className="pl-10 pr-8 py-2 rounded-lg bg-white/5 border border-white/10 text-white focus:ring-2 focus:ring-[#edfc3a] focus:border-transparent appearance-none"
            >
